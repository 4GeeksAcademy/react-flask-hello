...
export const RegistroForm = () => {
  ...
  const handleSubmit = async (e) => { // <-- Asegúrate de que esta función sea 'async'
    ...
    // Define el objeto 'nuevoUser' aquí, al inicio de la función handleSubmit
    ...
    try {
      ...
      const response = await fetch("https://friendly-journey-r49vwgpppjqhx74g-3001.app.github.dev/api/user/register", {
        method: "POST",
