...
Revision ID: ce9eba0cd68a
Revises: 0b67aef305cd
Create Date: 2025-10-17 16:53:29.626621
...
revision = 'ce9eba0cd68a'
down_revision = '0b67aef305cd'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('avatar', sa.VARCHAR(length=50), autoincrement=False, nullable=False))
