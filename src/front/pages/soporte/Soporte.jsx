          ...
          <div className="Soporte__container">
            ...
            {!enviado ? (
              <form onSubmit={handleSubmit} className="Soporte__form" noValidate>
                ...
                <div className="Soporte__field">
                  <label htmlFor="email" className="Soporte__label">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="Soporte__actions">
                  <button type="submit" className="Soporte__button">
                    Enviar
                  </button>
                </div>
              </form>
            ) : (
              <div className="Soporte__success">
                <p>✅ Mensaje enviado. Nos pondremos en contacto cuanto antes.</p>
                <p>Muchas gracias.</p>
              </div>
            )}
          </div>
