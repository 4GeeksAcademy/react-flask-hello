...
import "./AddBusinessModal.css"; // Importamos nuestro CSS personalizado
...
const AddBusinessModal = () => {
  ...
  const handleNewBusinessSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        setBusinessErrorMessage(data.error || "Error al crear el negocio");
        return;
      }
      ...
      setBusinessErrorMessage("Error de conexión con el servidor");
    }
  };
