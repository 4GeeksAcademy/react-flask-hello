    ...
    <footer className=' container d-flex justify-content-between align-items-center p-3 my-4 border-top'>
      ...
      <ul className='nav'>
        <li className="nav-item">
          <a href="#" onClick={scrollToTop} className="nav-link px-2 text-body-secondary">Back top</a>
        </li>
        {/*<li className="nav-item">
      ...
      <a className='nav-link text-body-secondary' href='https://github.com/4GeeksAcademy/EchoBoard-Proyecto-Final-4geeks' target='blank'>
