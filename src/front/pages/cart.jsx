  ...
  const handleCheckout = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const facturaUrl = data.facturaUrl

        localStorage.setItem('factura', facturaUrl)

        const facturaResponse = await fetch(facturaUrl)
    ...
    <div className="container my-4">
      ...
      {loading && (
        <div className="text-center my-3">
          ...
          <p className="mt-2">Procesando tu compra...</p>
        </div>
      )}
