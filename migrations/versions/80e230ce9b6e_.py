...
Revision ID: 80e230ce9b6e
Revises: 
Create Date: 2024-02-18 23:53:30.246581
...
def upgrade():
    ...
    sa.Column('subscription_start_date', sa.String(length=120), nullable=False),
