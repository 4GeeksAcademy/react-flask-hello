...
<defs>
 	<g id="cube">
		...
		<use href="#cube_outline" stroke-linejoin="round" stroke-width="6" stroke="#14141742"/>
	</g>	
	...
	<linearGradient id="fade" gradientTransform="rotate(90)">
    	<stop offset="0" stop-color="#fbffe400"/* "#14141700" *//>
    	<stop offset="0.25" stop-color="#fbffe4ff"/* "#141417ff" *//>
    </linearGradient>
...
body{
  background-color: #fbffe4/* #141417 */;
  display: flex;
