...
const content = [
  ...
  { id: 6, title: <h2>Hydration</h2>, description: "Track your water intake today and stay well hydrated.", img: <img src={hydrationImg} alt="Hydration" /> },
  { id: 7, title: <h2>Healthy Meal</h2>, description: "Prepare and eat a healthy meal packed with vegetables.", img: <img src={healthymealImg} alt="Healthy Meal" /> },
  ...
  { id: 10, title: <h2>Gratitude</h2>, description: "Write down 3 things you're grateful for today.", img: <img src={gratitudeImg} alt="Gratitude" /> },
  { id: 11, title: <h2>Journaling</h2>, description: "Take 10 minutes to write freely about your day or goals.", img: <img src={journalingImg} alt="Journaling" /> },
  { id: 12, title: <h2>Mindful Walk</h2>, description: "Go for a walk and focus on sights, sounds, and sensations.", img: <img src={mindfulwalkImg} alt="Mindful Walk" /> },
  { id: 13, title: <h2>Declutter</h2>, description: "Organize one space in your home to reduce visual noise.", img: <img src={declutterImg} alt="Declutter" /> },
  { id: 14, title: <h2>Cold Shower</h2>, description: "Start your day with a cold shower for energy and discipline.", img: <img src={coldshowerImg} alt="Cold Shower" /> },
  { id: 15, title: <h2>Early Wake-Up</h2>, description: "Wake up 30 minutes earlier and use that time for yourself.", img: <img src={earlywakeupImg} alt="Early Wake-Up" /> },
