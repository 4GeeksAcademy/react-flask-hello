...
Revision ID: 5c3d2788643b
Revises: 
Create Date: 2025-06-04 16:40:27.803628
...
def upgrade():
    ...
    sa.Column('homework', sa.Float(), nullable=False),
    sa.Column('midterm', sa.Float(), nullable=False),
    sa.Column('final_exam', sa.Float(), nullable=False),
