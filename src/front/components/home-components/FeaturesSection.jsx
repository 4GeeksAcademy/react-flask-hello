...
const FeaturesSection = () => {
    ...
    const featureCardsInfo =[
        {title:"My Missions", description: "Create your personal tasks. Each one is a mission for Elio Stay focused, stay disciplined.", buttonText: "Add mission", imgUrl:"https://dibujosycolores.com/objetos/sol/sol-9.jpg"},
