...
import { useStore } from "../hooks/useGlobalReducer";  // ✅ named export

export default function NewTask() {
  const { store /*, actions*/ } = useStore();          // ✅ usa useStore()
    ...
    <div className="container">
      ...
      <form className="border rounded-5 bg-light col-12 p-5">
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="task-title" placeholder="Escribe un título llamativo para tu tarea" />
        </div>
        ...
        <div className="mb-3">
          ...
          <div className="row">
            <div className="col-5">
              <label htmlFor="city" className="visually-hidden">Ciudad</label>
              <input type="text" className="form-control" id="city" placeholder="Ciudad" />
            </div>
            <div className="col-3">
              <label htmlFor="cp" className="visually-hidden">Código Postal</label>
              <input type="text" className="form-control" id="cp" placeholder="CP" />
            </div>
            <div className="col-4">
              <label htmlFor="country" className="visually-hidden">País</label>
        ...
        <div className="mb-3">
          <label htmlFor="details" className="form-label">Detalles de la tarea</label>
          <textarea className="form-control" id="details" rows="3" placeholder="Escribe los detalles de la tarea a resolver"></textarea>
        </div>
        ...
        <div className="my-3">
          <label className="form-check-label my-2" htmlFor="fotos">Sube algunas fotos</label>
