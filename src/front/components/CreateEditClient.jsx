            ...
            <form className="needs-validation" noValidate onSubmit={handleSubmit}>
              ...
              <div className="row g-3">
                <div className="col-md-6">
                  ...
                  <input type="text" className={edit ? "form-control" : "form-control-plaintext"} id="nombre" placeholder="Ej: Juan" required readOnly
                    name="nombre"
                ...
                <div className="col-md-6">
                  ...
                  <input type="text" className={edit ? "form-control" : "form-control-plaintext"} id="apellido" placeholder="Ej: Pérez" required
                    name="apellido"
                    onChange={handleChange}
                ...
                <div className="col-md-6">
                  ...
                  <input type="text" className={edit ? "form-control" : "form-control-plaintext"} id="nickname" placeholder="Ej: Spidy" required
                    name="nickname"
                    onChange={handleChange}
                ...
                <div className="col-md-6">
                  ...
                  <input type="tel" className={edit ? "form-control" : "form-control-plaintext"} id="telefono" placeholder="+34 600 000 000"
                    name="telefono"
                    onChange={handleChange}
                ...
                <div className="col-md-4">
                  ...
                  <input type="text" className={edit ? "form-control" : "form-control-plaintext"} id="dni"
                    name="dni"
                    onChange={handleChange}
                    value={userData.dni || ""}
                  />
                ...
                <div className="col-md-4">
                  ...
                  <input type="date" className={edit ? "form-control" : "form-control-plaintext"} id="fechaNacimiento"
              ...
              <div className="row g-3">
                <div className="col-12">
                  ...
                  <input type="text" className={edit ? "form-control" : "form-control-plaintext"} id="direccion" placeholder="Calle, número, ciudad"
                    name="direccion"
                    onChange={handleChange}
                ...
                <div className="col-md-6">
                  ...
                  <input type="text" className={edit ? "form-control" : "form-control-plaintext"} id="ciudad"
                    name="ciudad"
                    onChange={handleChange}
                ...
                <div className="col-md-3">
                  ...
                  <input type="text" className={edit ? "form-control" : "form-control-plaintext"} id="codigoPostal"
                    name="cp"
                    onChange={handleChange}
                    value={userData.cp || ""}
                  />
                ...
                <div className="col-md-3">
                  ...
                  <input type="text" className={edit ? "form-control" : "form-control-plaintext"} id="pais" defaultValue="España"
                    name="pais"
                    onChange={handleChange}
                    value={userData.pais || ""}
                  />
             ...
             { edit && 
              <div className="mt-5 text-end">
                <button type="reset" className="btn btn-outline-secondary me-2" onClick={handleCancel}>
