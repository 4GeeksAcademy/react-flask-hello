  ...
  <div className="privacidad-container">
    ...
    <div className="privacidad-content">
      ...
      <ul>
        ...
        <li>Datos de pago (procesados de forma segura, no almacenamos números completos)</li>
      </ul>
      ...
      <p>
        ...
        Escríbenos a <a href="mailto:privacidad@gamestore.com">privacidad@gamestore.com</a>.
      </p>

      <h3>Cookies</h3>
      <p>
        Usamos cookies para funcionamiento, análisis y publicidad. 
        Más información en nuestra <a href="https://www.google.com/">Política de Cookies</a>.
      </p>
