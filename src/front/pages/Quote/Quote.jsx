  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setIsLoading(false);
        // Marcar PDF como listo después de cargar datos
        setIsPdfReady(true);
      }
    };
    ...
    <div className="quote-editor-container">
      ...
      <form onSubmit={handleSubmit} className="quote-form">
        ...
        <div className="editor-card">
          ...
          <div className="email-container">
            <h3 className="email-title">Enviar por correo electrónico</h3>
            <div className="email-form">
              ...
              <button
                ...
                className={`button ${isFormValid && userEmail && !isEmailSending ? "email-button" : "disabled-button"}`}
              >
                <span className="button-icon">📧</span>
      ...
      {showPreview && (
        <div className="preview-container">
          <h2 className="section-title">Vista Previa del Presupuesto</h2>
          <div className="quote-preview">
            <div className="quote-preview-header">
              <div className="logo-container">
              <img src={LogoDronFarm} alt="DronFarm Logo" className="quote-preview-logo" />
                <h1 className="quote-preview-title">Presupuesto de Servicios Agrícolas</h1>
              </div>
